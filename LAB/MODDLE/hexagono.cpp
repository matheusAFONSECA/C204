...
{
	// declaracao de var
	ponto vetor[100];  // guarda os pontos do poligono(hexagono por exemplo)
 	int i;  // contador
 	float areaTotal;  // area total do poligono
	...
	// chamada de funcao que calcula a area
	areaTotal = area_poligono(vetor, 6);
	
	// saida do valor da area
	cout << fixed << setprecision(2);
	cout << "Area do escudo: " << areaTotal << endl;
