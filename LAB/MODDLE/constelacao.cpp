...
int main()
{
	...
	ponto vetor[100];  // vetor de pontos dados da contelacao
	list <ponto> Valor;  // lista que guarda os valore da pilha retornada
						 // essa pilha dita a quantidade de lados do fecho 
						 // convexo que forma a constelacao
	int i;  // contador
	...
	// saida da quantidade de lados
	Valor = Graham_scan(vetor, n);
	cout << Valor.size() << " lados" << endl;
